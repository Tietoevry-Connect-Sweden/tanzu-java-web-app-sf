...
```json
{
  "projectName" : "tanzu-java-web-app-sf",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-app-s...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: tanzu-java-web-app...(truncated)]
